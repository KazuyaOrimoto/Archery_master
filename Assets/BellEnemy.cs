            ...
            else
            {
                if (charge)
                {
                    if (effect == null)
                    {
                        ...
                        effect = Instantiate(flashEffect, camera.transform);
                        effect.transform.position = camera.transform.forward * 0.5f;
                        charged = true;
                    }
                }
            }
